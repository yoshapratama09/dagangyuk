        ...
        <nav class="container-xxl flex-wrap flex-md-nowrap" aria-label="Main navigation">
            ...
            <div class="navbar-collapse collapse show" id="bdNavbar">
                <ul class="navbar-nav flex-row flex-wrap ms-md-auto justify-content-evenly">
                    ...
                    <li class="nav-item col-11 col-md-auto mx-1">
                        <a class="nav-link" data-toggle="modal" data-target="#add_data_Modal" style="cursor: pointer;">LOG IN</a>
                    </li>
                    <li class="nav-item col-11 col-md-auto mx-1">
                        <a class="nav-link" data-toggle="modal" data-target="#register_Modal" style="cursor: pointer;">SIGN UP</a>
                    </li>
                    ...
                    <li class="nav-item col-1 col-md-auto mx-auto">
                        <a class="nav-link" href=""><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="white" class="bi bi-person-circle" viewBox="0 0 16 16">
            ...
            <div class="col-lg-8 col-sm-auto" style="color:white; text-align: right;">
                ...
                <div class="row justify-content-center mb-5" style="text-align:center;">
                    <div class="col-lg-3 col-sm-auto">
                        <button class="btn btn-danger" type="button" data-toggle="modal" data-target="#add_data_Modal" style="font-size:36px;">LOG IN</button>
                    </div>
                    <div class="col-lg-3 col-sm-auto align-middle">
                        <h3>or</h3>
                    </div>
                    <div class="col-lg-3 col-sm-auto">
                        <button class="btn btn-danger" type="button" data-toggle="modal" data-target="#register_Modal" style="font-size:36px;">REGISTER</button>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <form class="form-signin" method="post" action="Auth">
                    <div class="modal-body justify-content-center" style="text-align: center;">
                        ...
                        <p>Belum punya akun? <a href="" class="link" data-toggle="modal" data-target="#register_Modal" data-dismiss="modal">DAFTAR</a></p>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-signup" method="post" action="Auth/register">
                    <div class="modal-body justify-content-center" style="text-align: center;">
                        <div class="form-floating mb-2 mx-auto">
                            <input type="text" class="form-control" id="namalengkap" name="namalengkap" placeholder="Nama Lengkap" required autofocus>
                        ...
                        <p>Sudah punya akun? <a href="" class="link" data-toggle="modal" data-target="#add_data_Modal" data-dismiss="modal">MASUK</a></p>
                    </div>
                    <div class="modal-footer" style="text-align:center;">
                        <button type="submit" class="btn btn-primary my-3 mx-auto" name="submit" style="width:80%;"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" class="bi bi-facebook" viewBox="0 0 16 16">
                                <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" />
